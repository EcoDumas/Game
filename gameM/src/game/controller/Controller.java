...
public class Controller {
    ...
    public void cmbLive(ActionEvent event) {
        if (Live.getSelectionModel().getSelectedItem().equals("Playstation")) {
            cb1.setText("Gta 5");
            cb2.setText("COD");
            cb3.setText("Crash Racing");
            cb4.setText("NFS");
        }
        if (Live.getSelectionModel().getSelectedItem().equals("Xbox")) {
            cb1.setText("Gta 4");
            cb2.setText("Apex");
            cb3.setText("RS");
            cb4.setText("Fortnite");
        }
        if (Live.getSelectionModel().getSelectedItem().equals("PC")) {
            cb1.setText("Cs:go");
            cb2.setText("Cs 1.6");
            cb3.setText("Runescape");
            cb4.setText("Speed");
        }
    }
    ...
    public void create(ActionEvent event) {
        ...
        if (!Validation.isValidName(name1)) {
            ...
            Game bet = new Game(name1, age1, country, bet1, eventLive, game, payment);
            GameDAO gameDAO = new GameDAO();
            String msg = gameDAO.add(bet);
            warning.setText(msg);
    ...
    public void delete() {
        GameDAO gameDAO = new GameDAO();
        gameDAO.deleteById(Integer.parseInt((String) (id.getText())));
    ...
    public void updateTableFromDB(String teamName) {
        GameDAO gameDAO = new GameDAO();
        rsAllEntries = gameDAO.searchByTeamName(teamName);
    ...
    public void update(ActionEvent event) {
        ...
        if (!Validation.isValidName(name1)) {
            ...
            // public Bet(String name, int age, String country, int bet, String event, String game, String payment)
            Game bet = new Game(id1, name1, age1, country, bet1, eventLive, game, payment);
            GameDAO gameDAO = new GameDAO();
            gameDAO.editById(bet);
